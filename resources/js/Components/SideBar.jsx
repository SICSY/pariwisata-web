...
const SideBar = () => {
  ...
  return (
    <div className='flex flex-col w-64 h-screen bg-gray-800 text-white border-gray-800 border rounded-xl overflow-hidden box-border'>
      {/* Logo */}
      <div className='flex items-center justify-center h-16 bg-gray-900 font-bold text-xl'>Admin Panel</div>

      {/* Menu Links */}
      <nav className='flex flex-col mt-4'>
        <Link href='/admin/dashboard' className='flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white'>
        ...
        <div>
          <ul className='flex flex-col text-gray-300'>
            <li className='flex items-center px-4 py-3 hover:bg-gray-700 hover:text-white cursor-pointer' onClick={toggleDropdown}>
              ...
              <svg className='h-5 w-5 text-slate-500 ml-auto' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
            ...
            {showDropdown && (
              <div className='flex flex-col space-y-1 mt-1 pl-8'>
                <li>
                  <Link href='/admin/data/hotel' className='flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white'>
                    <span className='material-icons'>
                ...
                <li>
                  <Link href='/admin/data/kolam-renang' className='flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white'>
                    <span className='material-icons'>
                      <svg className='w-7 h-7  text-white/90 relative flex right-1' viewBox='0 60 140 100' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path
                ...
                <li>
                  <Link href={route('admin.pengunjung')} className='flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white'>
                    <span className='material-icons'>
                      <svg className='w-7 h-7  text-white/90 relative flex right-1' viewBox='0 60 140 100' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path
                          d='M90.8601 125.51C85.4101 132.65 65.8601 132.99 59.2501 126.07C53.0601 133.18 31.6601 133.99 24.6801 120.39L28.8401 115.83C35.0501 125.42 51.3701 126.45 58.6601 115.83C59.1215 115.778 59.5856 115.751 60.0501 115.75C64.7901 123.75 78.19 125.34 85.7701 120.1C85.69 109.88 85.4501 79.1001 85.4501 76.7001C85.4501 56.5301 112.86 57.8301 111.28 78.6001L105.18 79.1301C105.18 68.4901 93.8701 69.0401 93.8601 76.7901C93.8601 78.8901 94.0701 109.27 94.1401 118.38C101.88 124.81 114.83 123.91 121.36 116.06L125.36 119.67C118.74 133.64 98.7701 133.21 90.8601 125.51ZM73.4901 103.9C67.3801 103.82 58.0401 103.84 52.7201 103.9C52.7801 109.63 52.8301 113.9 52.8301 113.9L44.5301 116.34C44.5301 116.34 44.1801 79.7801 44.1801 76.7501C44.1801 56.5801 71.8701 57.5401 70.2901 77.3901L63.9201 78.6301C63.9201 67.2501 52.5001 69.5201 52.5001 76.6301C52.5001 80.8601 52.5601 88.7301 52.6401 96.1501L80.9201 95.8301C80.9201 95.8301 82.4701 104 73.4901 103.9ZM58.6601 133C59.1215 132.946 59.5855 132.916 60.0501 132.91C65.8301 142.62 84.4801 142.91 89.7601 132.85H91.4901C98.4901 142.15 114.01 142.09 121.36 133.26L125.36 136.87C118.78 150.87 98.8101 150.41 90.9001 142.71C85.4501 149.85 65.9001 150.18 59.2901 143.27C53.1001 150.38 31.7001 151.18 24.7201 137.59L28.8401 133C35.0501 142.62 51.3701 143.65 58.6601 133Z'
                    ...
                    <span className='ml-2'> Pengunjung</span>
                  </Link>
                </li>
              </div>
            )}
        ...
        <Link href='#' className='flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white'>
          <span className='material-icons'>
            <svg className='h-5 w-5 text-white-900' fill='none' viewBox='0 0 20 22' stroke='currentColor'>
        ...
        <Link href='#' className='flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white'>
          <span className='material-icons'>
            <svg class=' left-[0.9px]  flex relative h-5 w-5 text-white/80' viewBox='0 0 25 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'>
        ...
        <Link href='#' className='flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white'>
          <span className='material-icons'>
            <svg className='h-6 w-6 text-white/70' width='24' height='24' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'>
              {" "}
        ...
        <Link href='#' className='flex items-center px-4 py-4 text-gray-300 hover:bg-gray-700 hover:text-white'>
          <span className='material-icons'>
            <svg fill='#ffffff' height='20px' width='21px' version='1.1' id='Capa_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 28.048 28.048' xml:space='preserve'>
              <g>
                <path
